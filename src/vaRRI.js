...
(function (global) {
    ...
    /** Compact linear-RRI backbone spans relative to Fornac's natural link distance. */
    const LINEAR_RRI_DISTANCE_SCALE = 0.9;
    ...
    *     Generic subsequence-highlight definitions.
    ...
    function getLinearRriConstraintSpecs(v) {
        ...
        for (let i = 1; i < pairs.length; i++) {
            ...
            const distanceUnits = LINEAR_RRI_DISTANCE_SCALE *
    ...
    function applyLinearRriLayout(container, v) {
        ...
        positionLinearRriBridgeNodes(
            ...
            pairs,
            pairNodes,
            LINEAR_RRI_DISTANCE_SCALE * linkDistanceMultiplier,
            normalX,
            normalY
        );
